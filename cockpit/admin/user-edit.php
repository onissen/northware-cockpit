...
<?php
    ...
    if (isset($_REQUEST['id'])) {
        ...
        $currentUser = $db_cockpit->query("SELECT * FROM users WHERE id = $id")->fetchObject();
        $currentUser->pwdehashed = password_verify($currentUser->password);
    }
...
<form method="post">
    <div class="row mb-3">
        ...
        <div class="col-10">
            <input type="text" name="username" id="edit-username" class="form-control" autocomplete="off" placeholder="Benutzername" value="<?php echo $currentUser->username ?>">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-10">
            <input type="text" name="name" id="new-name" class="form-control" autocomplete="off" placeholder="Anzeigename" value="<?php echo $currentUser->name ?>">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-10">
            <input type="text" name="password" id="new-password" class="form-control" autocomplete="off" placeholder="Passwort" value="<?php echo $currentUser->pwdehashed ?>">
        </div>
    </div>
