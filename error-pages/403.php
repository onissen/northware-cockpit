<?php
    $service = 'cockpit';
    $siteTitle = '403 - Zugriff verweigert';
    require '../components/header.php';
?>

<section class="error-section text-center">
    <img id="illustration403" class="img-fluid mb-5" src="http://northware-cockpit.test/utilities/403-illustration.png">
    <h1 class="error-title">Error 403</h1>
    <h3 class="error-description">Du bist nicht berechtigt, diese Seite zu besuchen</h3>
